...
<template>
  ...
  >
    <div class="container">
      <div
        class="flex md:justify-between lg:justify-between sm:justify-between justify-between items-center"
      >
        <div class="flex items-center">
          <i-quill-hamburger
            class="cursor-pointer mr-[20px] lg:hidden md:hidden sm:hidden block"
            width="100"
            height="45"
          ></i-quill-hamburger>

          <img class="cursor-pointer" src="@/assets/logo.svg" alt="LOGO" />
          <div class="flex gap-4 w-full">
            <n-input
              class="!w-full hidden sm:flex md:flex lg:flex"
              type="text"
              placeholder="Search"
            />
            <n-select
              class="w-[250px] max-w-[250px] border-none hidden sm:hidden md:hidden lg:block"
              v-model:value="value"
              :options="options"
            />
      ...
      <n-input
        class="!w-full lg:hidden md:hidden sm:hidden !border-red-500 flex mt-[10px] bg-[#F7FAFC]"
        type="text"
        placeholder="Search"
      />
    </div>
  ...
  <div class="border-b bg-white lg:flex md:flex sm:hidden hidden py-[22px]">
    <div class="container py-4 flex items-center gap-2">
      ...
      <ul class="flex items-center gap-[25px]">
        <li
          class="not-italic font-medium text-base leading-5 text-[#1C1C1C] cursor-pointer"
        >
          All category
        </li>
        <li
